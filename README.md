...
This repository is a starter template that combines the TypeScript Snap Template with a Truffle Box, for developing and testing snaps that interact with smart contracts. 
